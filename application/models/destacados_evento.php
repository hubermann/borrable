...
class Destacados_evento extends CI_Model{
...
public function get_destacado_principal(){
	...
	$c = $this->db->get('destacados_eventos');
...
public function update_destacado_principal($nuevo_destacado){
	if(!empty($nuevo_destacado)){
		$this->db->query("UPDATE destacados_eventos SET destacado_principal = $nuevo_destacado");
	}

}
public function update_destacado_secundario_1($nuevo_destacado){
	if(!empty($nuevo_destacado)){
		$this->db->query("UPDATE destacados_eventos SET destacado_secundario_1 = $nuevo_destacado");
	}
...
public function update_destacado_secundario_2($nuevo_destacado){
	if(!empty($nuevo_destacado)){
		$this->db->query("UPDATE destacados_eventos SET destacado_secundario_2 = $nuevo_destacado");
	}
...
public function update_destacado_secundario_3($nuevo_destacado){
	if(!empty($nuevo_destacado)){
		$this->db->query("UPDATE destacados_eventos SET destacado_secundario_3 = $nuevo_destacado");
	}
...
public function update_destacado_secundario_4($nuevo_destacado){
	if(!empty($nuevo_destacado)){
		$this->db->query("UPDATE destacados_eventos SET destacado_secundario_4 = $nuevo_destacado");
	}

}

public function update_destacado_sin_destacar($id_evento){
	if(!empty($id_evento)){
