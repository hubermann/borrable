...
?>
	...
	<article class="row clearfix nomargin">
		<div class="col-lg-9 col-md-9">
            ...
            if($autor->filename != ""){
              echo '<img src="'.base_url('images_usuarios/'.$autor->filename).'" width="40" alt="Profile"/>';
            }else{
              echo '<img src="'.base_url('public_folder/img/guestIcon.jpg').'" width="40" alt="Profile"/>';
            }
            ?>
					...
					<div class="info">
						<!--<p>Matt Cynamon</p>-->
						<p><a href="<?php echo base_url($categoria_nota->slug); ?>"><?php echo $nombre_categoria; ?></a></p>
						<i><?php echo $fecha; ?></i>
					</div>
				<!--	<ul class="share">
