...
echo '<td>'.$row->status.' </td>';
		...
		echo '<td> 
		<div class="btn-group">
		<a class="btn btn-small" onclick="confirm_delete('.$row->id.')" href="'.base_url('control/comentarios_notas/delete_comfirm/'.$row->id.'').'"><i class="fa fa-trash-o"></i></a>
		<a class="btn btn-small" href="'.base_url('control/comentarios_notas/editar/'.$row->id.'').'"><i class="fa fa-edit"></i></a>		
		<!--<a class="btn btn-small" href="'.base_url('control/comentarios_notas/detail/'.$row->id.'').'"><i class="fa fa-chain"></i></a>-->
		</div>
		</td>';
