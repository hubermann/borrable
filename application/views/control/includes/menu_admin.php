...
######## categorias_eventos
if($this->uri->segment(2)=="categorias_eventos"){
	echo '
	<!-- links categorias_eventos -->
<li class="treeview active">
<a href="#">
<i class="fa fa-bar-chart-o"></i>
<span>categorias_eventos</span></a>
<i class="fa fa-angle-left pull-right"></i>
<ul class="treeview-menu">
<li><a href="'.base_url('control/categorias_eventos').'"><i class="fa fa-angle-double-right"></i> Ver Todos</a></li>
<li><a href="'.base_url('control/categorias_eventos/form_new').'"><i class="fa fa-angle-double-right"></i> Crear nuevo</a></li>
</ul>
</li>
	';
}else{
	echo '
	<li>
        <a href="'.base_url('control/categorias_eventos').'">
            <i class="fa fa-dashboard"></i> <span>categorias_eventos</span>
        </a>
    </li>
	';
}
