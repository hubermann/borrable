...
public function nuevo(){
	if($this->session->userdata('front_logged_in')){
		$usuario_logged = $this->session->userdata('front_logged_in')['id'];
	}else{
		redirect('/');
	}
	$this->load->helper('form');
...
if ($this->form_validation->run() === FALSE){
		...
		redirect('nota/'.$this->input->post('nota_id').'/#comentarios', 'refresh');

	}else{


		$newcomentario_nota = array(
			'usuario_id' => $usuario_logged,
		...
		$this->session->set_flashdata('success_comentario', 'comentario_nota creado.');
		redirect('nota/'.$this->input->post('nota_id').'/#comentarios', 'refresh');
